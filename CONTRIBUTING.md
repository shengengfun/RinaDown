# Contributing to RinaDown

感谢你有意为 RinaDown 做贡献！/ Thank you for your interest in contributing to RinaDown!
...
4. 提交 PR 前确保相关 crate 的测试通过（例如 `cargo test -p rinadown_engine`）。
   Make sure the tests for the affected crates pass before opening a PR (e.g. `cargo test -p rinadown_engine`).

## 反馈问题 / Reporting Issues

请通过 [GitHub Issues](https://github.com/zerx-lab/RinaDown/issues) 或官网 [反馈页面](https://rinadown.zerx.dev/feedback) 提交问题。
Please report problems via [GitHub Issues](https://github.com/zerx-lab/RinaDown/issues) or the [feedback page](https://rinadown.zerx.dev/feedback) on the official site.

## 文档贡献 / Documentation Contributions

RinaDown 官网文档（<https://rinadown.zerx.dev/docs/>）与源码同仓库维护，欢迎通过 Pull Request 贡献或翻译。
The RinaDown documentation site (<https://rinadown.zerx.dev/docs/>) is maintained in this repository — contributions and translations via Pull Request are welcome.
...
提交 PR 时可选择 "docs" 模板（`.github/PULL_REQUEST_TEMPLATE/docs.md`），源码仓库地址：<https://github.com/zerx-lab/RinaDown>。
When opening a PR you can pick the "docs" template (`.github/PULL_REQUEST_TEMPLATE/docs.md`). Source repository: <https://github.com/zerx-lab/RinaDown>.
