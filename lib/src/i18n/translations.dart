...
class S {
  ...
  String get newDownload => _r('newDownload');
    String get videoParse => _r('videoParse');
  ...
  // 实时流量图（详情页）
  String get trafficTitle => _r('trafficTitle');
  String get trafficDown => _r('trafficDown');
  String get trafficUp => _r('trafficUp');
  ...
  String get perfNetU => _r('perfNetU');
  String get appearanceBackground => _r('appearanceBackground');
  String get appearanceBackgroundDesc => _r('appearanceBackgroundDesc');
  String get chooseImage => _r('chooseImage');
  String get removeBackground => _r('removeBackground');
  ...
  String get speedLimitUnitTitle => _r('speedLimitUnitTitle');
  String get speedLimitUnitTitleDesc => _r('speedLimitUnitTitleDesc');
