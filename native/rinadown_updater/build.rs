//! Embed Windows PE version information into `rinadown_updater.exe`.
//!
...
fn embed_version_info() {
    ...
    res.set("FileDescription", "RinaDown Update Helper");
    res.set("InternalName", "rinadown_updater");
    res.set("OriginalFilename", "rinadown_updater.exe");
    res.set(
        "LegalCopyright",
    ...
    if let Err(e) = res.compile() {
        ...
        println!("cargo:warning=rinadown_updater version resource failed: {e}");
    }
}
