...
const zhCN = {
  ...
  // Options page
  "options.title": "RinaDown 设置",
  "options.remoteDesc":
    "配置 rinadown_server 的地址与访问令牌，测试连接通过后即可在弹出窗中选择远程模式",
  ...
  "notify.sentToRinaDown": "{name} 已发送到 RinaDown",
  "notify.batchSentDetail": "{count} 个任务已发送到 RinaDown",
  "notify.sendFailed": "发送失败",
  "notify.connectionFailed": "无法连接到 RinaDown 应用: {message}",
  "notify.fallbackBrowser": "已回退到浏览器下载",
  "notify.fallbackBrowserDetail":
    "无法发送到 RinaDown，已交由浏览器继续下载: {url}",
  "notify.appUnavailable": "未检测到 RinaDown 应用",
  "notify.appUnavailableDetail":
    "已暂时改用浏览器自带下载。请确认 RinaDown 桌面端已启动，稍后将自动恢复接管。",
  ...
  // Context menu
  "contextMenu.sendToRinaDown": "使用 RinaDown 下载此链接",
  "contextMenu.sendImageToRinaDown": "使用 RinaDown 下载此图片",
  "contextMenu.sendVideoToRinaDown": "使用 RinaDown 下载此视频/音频",
  "contextMenu.sendPageToRinaDown": "使用 RinaDown 下载此页面",

  // Manifest
  "manifest.description":
    "拦截浏览器下载，发送到 RinaDown 桌面应用进行高速下载",
  ...
  "popup.tasks.appNotRunning": "RinaDown 未运行",
  "popup.tasks.startApp": "启动 RinaDown",
  ...
  "popup.quickDownload.sent": "已发送到 RinaDown",
  ...
  // 自定义协议（rinadown://）
  "options.protocol.label": "RinaDown 自定义协议",
  "options.protocol.enabled": "已启用，经 rinadown:// 唤起应用",
  "options.protocol.disabled": "关闭（默认）",
  "options.protocol.desc": "经 rinadown:// 协议唤起应用下载，Windows / macOS / Linux / Android 均支持。本机通道功能更全，建议仅在其不可用时开启",
