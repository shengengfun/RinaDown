...
const en: Record<MessageKey, string> = {
  ...
  // Options page
  "options.title": "RinaDown Settings",
  "options.remoteDesc":
    "Configure the rinadown_server address and access token. Remote modes unlock after the connection test passes.",
  ...
  "notify.sentToRinaDown": "{name} sent to RinaDown",
  "notify.batchSentDetail": "{count} tasks sent to RinaDown",
  "notify.sendFailed": "Send Failed",
  "notify.connectionFailed": "Cannot connect to RinaDown app: {message}",
  "notify.fallbackBrowser": "Fell back to browser download",
  "notify.fallbackBrowserDetail":
    "Could not send to RinaDown, fell back to browser: {url}",
  "notify.appUnavailable": "RinaDown app not detected",
  "notify.appUnavailableDetail":
    "Temporarily using the browser's built-in download. Make sure the RinaDown desktop app is running; interception will resume automatically.",
  ...
  // Context menu
  "contextMenu.sendToRinaDown": "Download this link with RinaDown",
  "contextMenu.sendImageToRinaDown": "Download this image with RinaDown",
  "contextMenu.sendVideoToRinaDown": "Download this video/audio with RinaDown",
  "contextMenu.sendPageToRinaDown": "Download this page with RinaDown",

  // Manifest
  "manifest.description":
    "Intercept browser downloads and send to RinaDown app for high-speed downloading",
  ...
  "popup.tasks.appNotRunning": "RinaDown is not running",
  "popup.tasks.startApp": "Start RinaDown",
  ...
  "popup.quickDownload.sent": "Sent to RinaDown",
  ...
  // Custom protocol (rinadown://)
  "options.protocol.label": "RinaDown Protocol",
  "options.protocol.enabled": "On — launch app via rinadown://",
  "options.protocol.disabled": "Off (default)",
  "options.protocol.desc": "Launch the app via the rinadown:// protocol — supported on Windows, macOS, Linux and Android. The native channel is more capable, so enable this only when it is unavailable",
