...
/**
 * RinaDown 单 FlutterEngine 保持者。
 *
 * RinadownMainActivity 与 ExternalDownloadActivity 共享同一个引擎，保证单 Dart 会话、
 ...
 */
object RinadownEngine {
    const val ENGINE_ID = "com.rinadown.app/engine"
